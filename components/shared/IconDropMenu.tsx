          ...
          <Popover.Button
            className={`flex ${
              size === 'large'
                ...
                ? 'h-10 w-10'
                : 'h-8 w-8'
            } default-transition items-center justify-center rounded-full border border-th-button text-th-fgd-1 focus:border-th-fgd-2 md:hover:border-th-button-hover md:hover:text-th-fgd-1 ${
