  ...
  const eventQueueFillsForOwner = useMemo(() => {
    ...
    return fills.filter((fill) => {
      if (isSerumFillEvent(fill)) {
        ...
        return  false //openOrderOwner ? fill.openOrders.equals(openOrderOwner) : false
